...
import { blogPosts, categories, projects, services, slides, teamMembers, testimonials } from '../constants/data.jsx';
                ...
                <div className="text-center mb-10">
                    <div className="flex flex-wrap justify-center gap-4">
                        {categories.map((cat, idx) => (
                            <button
                                key={idx}
                                className={`relative w-[150px] h-[100px] overflow-hidden rounded shadow-lg ${activeFilter === cat.filter ? "ring-4 ring-primary" : ""
                                    }`}
                                onClick={() => setActiveFilter(cat.filter)}
                            >
                                <img
                                    src={
                                        idx === 0 ? portfolio1 : idx === 1 ? portfolio2 : portfolio3
                                    }
                                    className="w-full h-full object-cover"
                                    alt={cat.name}
                                />
                    ...
                    {filteredProjects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black/30 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition p-4">
                                <Link to="#" className="bg-white p-3 shadow rounded mb-2">
                                    <p className="text-lg font-bold uppercase">Project Name</p>
